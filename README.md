...
###What do you mean by Integrity check of BIOS? Mention firmware other than BIOS
...
###What is the difference between BIOS & UEFI?
|BIOS | UEFI |
|--------------------------------- | -------------------------------- |
...
### When should you go for Ubuntu & when for other systems?
...
###. List various Linux distributions & their use cases.
...
###What does a systemd. unit (5) means?
...
Ans: squashfs file system is a read only file system that lets us compress whole file systems or single directories. We can write them to other devices/partitioned or to ordinary files and then we can mount them directly (if it is a device) or using a loopback device (if it is a file)
...
### What is the purpose of creating and using hidden files.
...
### How to check the port number of a process?
...
### What is the difference between sbin & usr/sbin?
...
### What is the difference between ufw & iptables?
ufw: 
...
used for transferring data over a network. Most information that is sent over the Internet, including website content and API calls, uses the HTTP protocol.
It was designed for communication between web browser and web server.

https:
HTTPS stands for Hypertext Transfer Protocol Secure
It is an extension of HTTP.
 It is used for server communication over a network.
It is a secure version of http

HTTPS uses TLS (or SSL) to encrypt HTTP requests and responses, so instead of the plaintext, an attacker would see a series of seemingly random characters.
...
### What is the difference between apt update & apt upgrade.
...
### What are the package managers used in Linux?
...
The number we mentioned is the number of hard links to a file. It always at least 1
(itself).
...
### How can I give access to someone to my AWS instance?
...
### What does a “. d" represent after a filename?
...
### What happens when a .pem file gets deleted?
...
### What information is stored in the /etc/host file?
...
### Create a unit file for any application.
